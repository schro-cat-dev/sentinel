...
| ID | 問題 | ステータス |
|----|------|-----------|
| Phase 1-E | ハッシュ方式不一致（SHA-256 vs HMAC） | ✅ HMAC-SHA256 モード追加 (#2) |
| Phase 1-F | 設定整合性検証なし | ✅ HealthCheck ConfigSummary (#3) |
| Phase 2-C | 脅威レスポンス SDK 未消費 | ✅ IngestionResult.threatResponses + onThreatResponse (#4) |
| Phase 2-A | 検知ルール同期なし | ✅ dual-mode ruleId dedup + Server task merge (#5) |
| Phase 3-B | タスク承認フロー SDK 未接続 | ✅ ServerManagementTransport 7メソッド (#6) |
| Phase 3-D | タスク状態管理 SDK 未接続 | ✅ getTaskStatus/listTasks (#7) |
...
| 優先度 | 合計 | ✅完了 | ⏳進行中 | ⚠保留/NA | 理由 |
|--------|------|--------|---------|----------|------|
| P0 | 4 | 4 | 0 | 0 | |
| P1 | 6 | 6 | 0 | 0 | |
| P2 | 14 | 13 | 0 | 1 | CFG-01: 意図的NA |
| P3 | 9 | 8 | 0 | 1 | DEAD-03: 鍵管理設計必要 |
| 耐障害性/可観測性 | 5 | 5 | 0 | 0 | |
