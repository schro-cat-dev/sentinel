...
### SDK ↔ Server 連携 — 2/6件完了

| ID | 問題 | ステータス |
|----|------|-----------|
| Phase 1-E | ハッシュ方式不一致（SHA-256 vs HMAC） | ✅ HMAC-SHA256 モード追加 (#2) |
| Phase 1-F | 設定整合性検証なし | ✅ HealthCheck ConfigSummary (#3) |
| Phase 2-C | 脅威レスポンス SDK 未消費 | ⏳ #4 |
| Phase 2-A | 検知ルール同期なし | ⏳ #5 |
| Phase 3-B | タスク承認フロー SDK 未接続 | ⏳ #6 |
| Phase 3-D | タスク状態管理 SDK 未接続 | ⏳ #7 |
...
| 耐障害性/可観測性 | 5 | 5 | 0 | 0 | |
| SDK↔Server連携 | 6 | 2 | 4 | 0 | Phase 2-3 残 |
| Go | 5 | 5 | 0 | 0 | |
| **合計** | **49** | **43** | **4** | **2** | |
