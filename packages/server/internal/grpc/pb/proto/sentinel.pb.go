...
type ThreatResponseSummary struct {
	...
	BlockTarget   string                 `protobuf:"bytes,5,opt,name=block_target,json=blockTarget,proto3" json:"block_target,omitempty"`
...
func (x *ThreatResponseSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ThreatResponseSummary) GetEventName() string {
	if x != nil {
		return x.EventName
	}
	return ""
...
func (x *ThreatResponseSummary) GetStrategy() string {
	if x != nil {
		return x.Strategy
	}
	return ""
...
func (x *ThreatResponseSummary) GetBlocked() bool {
	if x != nil {
		return x.Blocked
	}
	return false
...
func (x *ThreatResponseSummary) GetBlockTarget() string {
	if x != nil {
...
func (x *ThreatResponseSummary) GetAnalyzed() bool {
	if x != nil {
		return x.Analyzed
	}
	return false
...
func (x *ThreatResponseSummary) GetRiskLevel() string {
	if x != nil {
		return x.RiskLevel
	}
	return ""
...
func (x *ThreatResponseSummary) GetNotified() bool {
	if x != nil {
		return x.Notified
	}
	return false
...
type IngestResponse struct {
	...
	ThreatResponses []*ThreatResponseSummary `protobuf:"bytes,5,rep,name=threat_responses,json=threatResponses,proto3" json:"threat_responses,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *IngestResponse) GetThreatResponses() []*ThreatResponseSummary {
	if x != nil {
		return x.ThreatResponses
	}
	return nil
}
...
type HealthCheckResponse struct {
	...
	ConfigSummary *ConfigSummary         `protobuf:"bytes,3,opt,name=config_summary,json=configSummary,proto3" json:"config_summary,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HealthCheckResponse) GetConfigSummary() *ConfigSummary {
	if x != nil {
...
type ConfigSummary struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	MaskingRulesCount   int32                  `protobuf:"varint,1,opt,name=masking_rules_count,json=maskingRulesCount,proto3" json:"masking_rules_count,omitempty"`
	DetectionRulesCount int32                  `protobuf:"varint,2,opt,name=detection_rules_count,json=detectionRulesCount,proto3" json:"detection_rules_count,omitempty"`
	TaskRulesCount      int32                  `protobuf:"varint,3,opt,name=task_rules_count,json=taskRulesCount,proto3" json:"task_rules_count,omitempty"`
	HashChainEnabled    bool                   `protobuf:"varint,4,opt,name=hash_chain_enabled,json=hashChainEnabled,proto3" json:"hash_chain_enabled,omitempty"`
	MaskingEnabled      bool                   `protobuf:"varint,5,opt,name=masking_enabled,json=maskingEnabled,proto3" json:"masking_enabled,omitempty"`
...
func (x *ConfigSummary) GetMaskingRulesCount() int32 {
	if x != nil {
		return x.MaskingRulesCount
	}
	return 0
}

func (x *ConfigSummary) GetDetectionRulesCount() int32 {
	if x != nil {
		return x.DetectionRulesCount
	}
	return 0
}

func (x *ConfigSummary) GetTaskRulesCount() int32 {
	if x != nil {
		return x.TaskRulesCount
	}
	return 0
}

func (x *ConfigSummary) GetHashChainEnabled() bool {
	if x != nil {
		return x.HashChainEnabled
	}
	return false
}

func (x *ConfigSummary) GetMaskingEnabled() bool {
	if x != nil {
...
func (x *ConfigSummary) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
const file_proto_sentinel_proto_rawDesc = "" +
	...
	"\x15ThreatResponseSummary\x12\x1f\n" +
	...
	"\fblock_target\x18\x05 \x01(\tR\vblockTarget\x12\x1a\n" +
	"\banalyzed\x18\x06 \x01(\bR\banalyzed\x12\x1d\n" +
	"\n" +
	"risk_level\x18\a \x01(\tR\triskLevel\x12\x1a\n" +
	"\bnotified\x18\b \x01(\bR\bnotified\"\xfe\x01\n" +
	...
	"\x0ftasks_generated\x18\x04 \x03(\v2\x17.sentinel.v1.TaskResultR\x0etasksGenerated\x12M\n" +
	"\x10threat_responses\x18\x05 \x03(\v2\".sentinel.v1.ThreatResponseSummaryR\x0fthreatResponses\"\x91\x01\n" +
	"\n" +
	"TaskResult\x12\x17\n" +
	...
	"\x0econfig_summary\x18\x03 \x01(\v2\x1a.sentinel.v1.ConfigSummaryR\rconfigSummary\"\x93\x02\n" +
	"\rConfigSummary\x12.\n" +
	"\x13masking_rules_count\x18\x01 \x01(\x05R\x11maskingRulesCount\x122\n" +
	"\x15detection_rules_count\x18\x02 \x01(\x05R\x13detectionRulesCount\x12(\n" +
	"\x10task_rules_count\x18\x03 \x01(\x05R\x0etaskRulesCount\x12,\n" +
	"\x12hash_chain_enabled\x18\x04 \x01(\bR\x10hashChainEnabled\x12'\n" +
	"\x0fmasking_enabled\x18\x05 \x01(\bR\x0emaskingEnabled\x12\x1d\n" +
	"\n" +
	"service_id\x18\x06 \x01(\tR\tserviceId\"/\n" +
...
var file_proto_sentinel_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_proto_sentinel_proto_goTypes = []any{
	...
	(*ConfigSummary)(nil),              // 9: sentinel.v1.ConfigSummary
	(*GetTaskStatusRequest)(nil),       // 10: sentinel.v1.GetTaskStatusRequest
	(*GetTaskStatusResponse)(nil),      // 11: sentinel.v1.GetTaskStatusResponse
	(*ListTasksRequest)(nil),           // 12: sentinel.v1.ListTasksRequest
	(*ListTasksResponse)(nil),          // 13: sentinel.v1.ListTasksResponse
	(*ApproveTaskRequest)(nil),         // 14: sentinel.v1.ApproveTaskRequest
	(*ApproveTaskResponse)(nil),        // 15: sentinel.v1.ApproveTaskResponse
	(*RejectTaskRequest)(nil),          // 16: sentinel.v1.RejectTaskRequest
	(*RejectTaskResponse)(nil),         // 17: sentinel.v1.RejectTaskResponse
	(*ListPendingBlocksRequest)(nil),   // 18: sentinel.v1.ListPendingBlocksRequest
	(*PendingBlockInfo)(nil),           // 19: sentinel.v1.PendingBlockInfo
	(*ListPendingBlocksResponse)(nil),  // 20: sentinel.v1.ListPendingBlocksResponse
	(*ApproveBlockRequest)(nil),        // 21: sentinel.v1.ApproveBlockRequest
	(*ApproveBlockResponse)(nil),       // 22: sentinel.v1.ApproveBlockResponse
	(*RejectBlockRequest)(nil),         // 23: sentinel.v1.RejectBlockRequest
	(*RejectBlockResponse)(nil),        // 24: sentinel.v1.RejectBlockResponse
